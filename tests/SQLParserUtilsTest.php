...
namespace staabm\SqlParserUtils\Tests;

use staabm\SqlParserUtils\Connection;
use staabm\SqlParserUtils\ParameterType;
use staabm\SqlParserUtils\SQLParserUtils;
use staabm\SqlParserUtils\SQLParserUtilsException;

class SQLParserUtilsTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @return mixed[][]
     */
